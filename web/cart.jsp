        ...
        <section id="cart-add" class="section-p1">
            ...
            <div class="subtotal">
                ...
                <form action="VNPayServlet" method="post">
                    ...
                    <input type="hidden" name="orderInfo" value="Order info here"> <!-- Thông tin ??n hàng -->
                    <!-- Thay ??i nút "Submit" -->
                    <input type="submit" name="VNP" value="Pay with VNPay" class="btn btn-success">
