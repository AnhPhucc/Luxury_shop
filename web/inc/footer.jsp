...
<section id="newsletter" class="section-p1 section-m1">
    ...
    footer {
        background-color: black; /* Màu nền là đen cho footer */
        color: white; /* Màu chữ trắng */
    }

    footer h4, footer p, footer a {
        color: white; /* Đảm bảo tất cả tiêu đề, đoạn văn và liên kết đều có màu trắng */
    }

    footer a:hover {
        color: lightgray; /* Thay đổi màu khi di chuột qua liên kết (tuỳ chọn) */
    }
</style>
